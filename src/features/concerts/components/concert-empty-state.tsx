...
const CONTAINER_CLASS = "flex flex-col items-center justify-center gap-4 rounded-xl border border-dashed border-gray-300 bg-gray-50 px-6 py-16 text-center";
const ICON_CLASS = "h-12 w-12 text-gray-400";
const TITLE_CLASS = "text-lg font-semibold text-gray-900";
const DESCRIPTION_CLASS = "max-w-md text-sm text-gray-600";
