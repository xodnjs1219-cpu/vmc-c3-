...
const BUTTON_CLASS = 'h-12 w-12 rounded-full border-slate-700 hover:bg-slate-800';
const COUNT_WRAPPER_CLASS = 'flex min-w-[80px] items-center justify-center rounded-lg border border-slate-700 bg-slate-900/60 px-6 py-3';
const COUNT_TEXT_CLASS = 'text-2xl font-semibold text-white';
const COUNT_SUFFIX_CLASS = 'ml-1 text-sm text-slate-400';
